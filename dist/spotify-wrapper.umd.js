...
var SpotifyWrapper = function () {
    function SpotifyWrapper(options) {
        ...
        this.apiURL = options.apiURL || _config.API_URL, this.token = options.token, this.album = _album2.default.bind(this)(), this.search = _search2.default.bind(this)();
    }
...
var TOKEN_API = 'BQATsnczqc-EfPF-L7eF7bOit7P-C39hPNhZ2QLY6Sh9OPghQokFxaDUvGnhoWtN6BhXXDY9oC61Kt2xLrAqH4Fd31uJMM74G05oZZj18j9zS7DBf5cBnBGLpveAdaG-a2SS07YsTJcwo-IzOHFnaWLhPTdD-LWQqWuaGw';
